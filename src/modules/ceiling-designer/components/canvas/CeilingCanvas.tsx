...
export const CeilingCanvas = memo(function CeilingCanvas({
  ...
  const startDrag = useCeilingDesignerStore((state) => state.startDrag)
  const cancelDrag = useCeilingDesignerStore((state) => state.cancelDrag)
...
const CameraViewControls = memo(function CameraViewControls() {
  const setCameraView = useCeilingDesignerStore((state) => state.setCameraView)
  const currentView = useCeilingDesignerStore((state) => state.canvas.cameraView)

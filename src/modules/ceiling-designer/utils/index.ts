...
/**
 * Get human-readable component category name
 */
function getComponentTypeName(type: ComponentCategory): string {
  switch (type) {
...
function validateConnectionAngle(
  _sourceComponent: CeilingComponent,
  _targetComponent: CeilingComponent,

 ...
 * 
 * Main page component for the ceiling lighting designer.
 * Composed of left sidebar, center canvas, and right properties panel.
 * Professional white theme with optimized layout.
 * Features: Collapsible/resizable sidebars, fullscreen mode, adjustable panels.
 */
...
import { CeilingCanvas } from './components/canvas'
...
export const CeilingDesignerPage = memo(function CeilingDesignerPage() {
  ...
  const removeToast = useCeilingDesignerStore((state: CeilingDesignerState) => state.removeToast)
    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          leftSidebarOpen && `left-[${leftWidth}px]`
        )}
...
export default CeilingDesignerPage
